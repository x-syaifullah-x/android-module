...
class RemoteDataSource(
    ...
    fun signUp(email: String, password: String): Flow<NetworkResponse<UserResponse>> {
    ...
    fun sendVerification(): Flow<NetworkResponse<String>> {
        val flow = DataHelper.getAsFlow(
            blockFetch = {
    ...
    fun signIn(email: String, password: String): Flow<NetworkResponse<UserResponse>> {
        val flow = DataHelper.getAsFlow(
            blockFetch = {
                withTimeout(10000) {
