...
import id.xxx.module.activity.BindingAppCompatActivity

abstract class BaseActivityAppCompatActivity<ActivityViewBinding : ViewBinding> :
    id.xxx.module.activity.BindingAppCompatActivity<ActivityViewBinding>() {
